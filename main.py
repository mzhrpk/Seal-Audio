...
def main(page: ft.Page):
    ...
    # تطبيق الألوان الزيتونية الرسمية مالتك
    page.theme = ft.Theme(
    ...
    main_view = ft.Container(
        content=ft.Column([
            ...
            ft.Container(height=20), # فراغ آمن مية بالمية للأندرويد
            url_input,
        ]),
        expand=True,
        visible=True,
    ...
    # 3. واجهة التنزيلات والمكتبة (كلين وفارغة)
    downloads_view = ft.Container(
        content=ft.Column([
            ...
            # رسالة لطيفة ومطفية تبين إن القائمة فارغة
            ft.Row([
                ft.Column([
                    ft.Icon(ft.icons.FOLDER_OUTLINED, size=48, color="#8C9388"),
                    ft.Text("Empty", color="#8C9388", size=16)
